...
@Configuration //carrega as classes de configuracao
public class AppConfig {
    ...
    //metodo de cripitografia
    @Bean//permite gerenciar a criacao variavel em outro lugar
	...
	OpenAPI myOpenAPI() {
		...
		contato.setEmail("geisilascosta@gmail.com");
		contato.setName("Geisila Costa");
