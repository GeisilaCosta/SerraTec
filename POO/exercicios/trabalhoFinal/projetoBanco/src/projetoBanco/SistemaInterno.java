...
public class SistemaInterno {
    ...
    private static void menuPresidente(Presidente presidente) {
        int opcao;
        do {
            ...
            switch (opcao) {
                case 1:
                    menuMovimentacoesContaGerente(presidente); // O presidente tem as mesmas funcionalidades do gerente
                    break;
                case 2:
                    menuRelatoriosPresidente(presidente);
                    break;
                case 3:
